...
#define	shades(n, l)		saturate(dot(n, l))
    ...
    q11.xyz = ((GetLightAmount(IN.texcoord_6) * q29.xyz) + AmbientColor.rgb) * ((IN.LCOLOR_1.w * r13.xyz) + q10.xyz);
    q12.xyz = (IN.texcoord_7.w * (IN.texcoord_7.xyz - (IN.texcoord_1.xyz * q11.xyz))) + (q11.xyz * IN.texcoord_1.xyz);
    OUT.color_0.a = 1;
