...
#define	shades(n, l)		saturate(dot(n, l))
    ...
    q7.xyz = ((GetLightAmount(IN.texcoord_6) * (r7.w * PSLightColor[0].rgb)) + AmbientColor.rgb) * ((IN.LCOLOR_1.w * r13.xyz) + q6.xyz);
    q8.xyz = (IN.texcoord_7.w * (IN.texcoord_7.xyz - (IN.texcoord_1.xyz * q7.xyz))) + (q7.xyz * IN.texcoord_1.xyz);
    OUT.color_0.a = 1;
