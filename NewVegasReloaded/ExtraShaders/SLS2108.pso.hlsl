...
#define	shades(n, l)		saturate(dot(n, l))
    ...
    q4.xyz = ((GetLightAmount(IN.texcoord_6) * (shades(r1.xyz, m23.xyz) * PSLightColor[0].rgb)) + AmbientColor.rgb) * q3.xyz;
    q5.xyz = (IN.texcoord_7.w * (IN.texcoord_7.xyz - (IN.texcoord_1.xyz * q4.xyz))) + (q4.xyz * IN.texcoord_1.xyz);
    OUT.color_0.a = 1;
