...
#define	shades(n, l)		saturate(dot(n, l))
    ...
    q10.xyz = ((GetLightAmount(IN.texcoord_6) * q24.xyz) + AmbientColor.rgb) * ((IN.LCOLOR_1.y * r9.xyz) + ((IN.LCOLOR_1.x * r8.xyz) + q9.xyz));
    q11.xyz = (IN.texcoord_7.w * (IN.texcoord_7.xyz - (IN.texcoord_1.xyz * q10.xyz))) + (q10.xyz * IN.texcoord_1.xyz);
    OUT.color_0.a = 1;
