...
#define	TanSpaceProj	float3x3(r2.xyz, r4.xyz, q8.xyz)
    ...
    q8.xyz = normalize(((1 - weight(IN.LBLENDWEIGHT.xyz)) * r5.xyz) + r0.yzw);
    l12.xyz = mul(TanSpaceProj, normalize(normalize(EyePosition.xyz - r1.xyz) + LightData[0].xyz));
    OUT.texcoord_3.xyz = normalize(l12.xyz);
    l15.xyz = mul(TanSpaceProj, LightData[0].xyz);
    OUT.texcoord_1.xyz = normalize(l15.xyz);
