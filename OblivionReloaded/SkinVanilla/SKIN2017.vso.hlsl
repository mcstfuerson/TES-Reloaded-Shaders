...
#define	sqr(v)			((v) * (v))
    ...
    OUT.Light0Dir.xyz = mul(float3x3(q38.xyz, q17.xyz, q11.xyz), normalize(lit3.xyz));
    OUT.Light1Dir.xyz = mul(float3x3(q38.xyz, q17.xyz, q11.xyz), normalize(lit5.xyz));
    OUT.Att0UV.w = 0.5;
    OUT.Att0UV.xyz = compress(lit3.xyz / LightPosition[0].w);	// [-1,+1] to [0,1]
    OUT.Att1UV.w = 0.5;
    OUT.Att1UV.xyz = compress(lit5.xyz / LightPosition[1].w);	// [-1,+1] to [0,1]
    OUT.CameraDir.xyz = normalize(eye52.xyz);
