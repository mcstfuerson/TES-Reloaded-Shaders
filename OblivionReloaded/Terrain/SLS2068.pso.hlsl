...
// SMOOTH NORMALS
    ...
    r2.xyzw  = tex2D(TESR_samplerNormalMap, IN.NormalUV.xy);
    r2.xyz   = expand(r2.xyz);

    r2.xyz  += expand(tex2D(TESR_samplerNormalMap, IN.NormalUV.xy + float2(0,  1.0 / 1024.0)).xyz) * 0.666;
    r2.xyz  += expand(tex2D(TESR_samplerNormalMap, IN.NormalUV.xy + float2( 1.0 / 1024.0, 0)).xyz) * 0.666;
    r2.xyz  += expand(tex2D(TESR_samplerNormalMap, IN.NormalUV.xy + float2(0, -1.0 / 1024.0)).xyz) * 0.666;
    r2.xyz  += expand(tex2D(TESR_samplerNormalMap, IN.NormalUV.xy + float2(-1.0 / 1024.0, 0)).xyz) * 0.666;

    r2.xyz  += expand(tex2D(TESR_samplerNormalMap, IN.NormalUV.xy + float2( 1.0 / 1536.0,  1.0 / 1536.0)).xyz) * 0.333;
    r2.xyz  += expand(tex2D(TESR_samplerNormalMap, IN.NormalUV.xy + float2(-1.0 / 1536.0,  1.0 / 1536.0)).xyz) * 0.333;
    r2.xyz  += expand(tex2D(TESR_samplerNormalMap, IN.NormalUV.xy + float2( 1.0 / 1536.0, -1.0 / 1536.0)).xyz) * 0.333;
    r2.xyz  += expand(tex2D(TESR_samplerNormalMap, IN.NormalUV.xy + float2(-1.0 / 1536.0, -1.0 / 1536.0)).xyz) * 0.333;
