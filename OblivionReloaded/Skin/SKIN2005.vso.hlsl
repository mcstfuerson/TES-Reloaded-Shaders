...
//
//   vsa shaderdump19/SKIN2005.vso /Fcshaderdump19/SKIN2005.vso.dis
//
//
// Parameters:
//
...
#define	sqr(v)			((v) * (v))
    ...
    mdl40.xyz = mul(float3x4(SkinModelViewProj[0].xyzw, SkinModelViewProj[1].xyzw, SkinModelViewProj[2].xyzw), r0.xyzw);
