...
#define	sqr(v)			((v) * (v))
    ...
    q16.xyz = mul(float3x4(Bones[0 + offset.w].xyzw, Bones[1 + offset.w].xyzw, Bones[2 + offset.w].xyzw), q0.xyzw);
    q14.xyz = mul(float3x4(Bones[0 + offset.z].xyzw, Bones[1 + offset.z].xyzw, Bones[2 + offset.z].xyzw), q0.xyzw);
    q13.xyz = mul(float3x4(Bones[0 + offset.x].xyzw, Bones[1 + offset.x].xyzw, Bones[2 + offset.x].xyzw), q0.xyzw);
    q12.xyz = mul(float3x4(Bones[0 + offset.y].xyzw, Bones[1 + offset.y].xyzw, Bones[2 + offset.y].xyzw), q0.xyzw);
    q15.xyz = (IN.LBLENDWEIGHT.z * q14.xyz) + ((IN.LBLENDWEIGHT.x * q13.xyz) + (q12.xyz * IN.LBLENDWEIGHT.y));
    ...
    r4.xyz = normalize(((1 - weight(IN.LBLENDWEIGHT.xyz)) * r1.xyz) + r2.xyz);
    ...
    q5.xyz = normalize(((1 - weight(IN.LBLENDWEIGHT.xyz)) * r1.xyz) + r2.xyz);
    ...
    OUT.texcoord_9 = mul(r5, TESR_ShadowCameraToLightTransformSkin);
    OUT.texcoord_8 = mul(r5, TESR_InvViewProjectionTransform);
    OUT.texcoord_4 = mul(float3x3(r4.xyz, r3.xyz, q5.xyz), normalize(EyePosition.xyz - r0.xyz));
