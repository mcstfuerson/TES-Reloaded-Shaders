...
#define	sqr(v)			((v) * (v))
    ...
    q9.xy = (((((q7.x * ((q7.x * q8.x) - 0.5)) + 1) * RustleParams.z) * RustleParams.x) / (PI * 2)) + const_9.yz;
    r2.xy = angler(frac(q9.xy)) * angler(frac(q9.xy));
    q3.xy = (((((q1.x * ((q1.x * q2.x) - 0.5)) + 1) * RockParams.z) * RockParams.x) / (PI * 2)) + const_9.yz;
    ...
    r0.xw = (r0.yx * r1.yx) + 1;
    r1.xyzw = IN.blendindices.w * LeafBase[IN.blendindices.z];
    q13.xyz = normalize((LeafLighting.y * (r1.xyz / length(r1.xyzw))) + IN.normal.xyz);
    r0.y = -r0.w;
    ...
    q46.xyz = LightPos.xyz - r0.xyz;
    q14.x = saturate(length(q46.xyz) / LightPos.w);
    OUT.texcoord_0.xy = IN.texcoord_0.xy;
    OUT.texcoord_1.xyzw = ((1.0 - sqr(q14.x)) * (shades(q13.xyz, normalize(q46.xyz)) * DiffColorPt.xyzw)) + r1.xyzw;
